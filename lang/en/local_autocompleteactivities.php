...
$string['matching_label_description'] = "Add a comma-seperated list of the section label names that should be triggered by autocompletion when all other course modules in the same section are marked as completed";
$string['matching_module_whitelist'] =  "Matched Module Types";
$string['matching_module_whitelist_description'] = "Add a comma-seperated list of the module types that should be allowed to be autocompleted";
